...
## Insights
- Tech is the highest-performing category  
- Laptop is the top-selling product  
- Total revenue across the dataset: 1426  

This project showcases my ability to turn raw data into clear, actionable insights using Excel.
